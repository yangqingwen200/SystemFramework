			...
			keydown : function(e) {
				...
				if (e.keyCode == 13) {
                    ...
                    if(opts.length) {
                        ...
                        if(s.length + 1 > opts.length && e.keyCode != 8){
                            return false;
                        }
                    }
                }
...
(function($) {
	function _506(_507) {
		...
		/*if(opts.isNumberValue) {
			$(_507).textbox("options").css({
				imeMode : "disabled"
			});
		}*/
	...
	$.fn.searchbox.defaults = $.extend({}, $.fn.textbox.defaults, {
		inputEvents : $.extend({}, $.fn.textbox.defaults.inputEvents, {
			keydown : function(e) {
				...
				var s = t.searchbox("getText");
				if(opts.isNumberValue) {
					if (((e.which >= 48 && e.which <= 57) || (e.which >= 96 && e.which <= 105)) && e.ctrlKey == false && e.shiftKey == false) {
						if(opts.length) {
							if(s.length + 1 > opts.length){
								return false;
							}
						}
						return true;
					} else if(e.which == 8 || e.which == 37 || e.which == 39 || e.which == 46) {
						return true;
					} else {
